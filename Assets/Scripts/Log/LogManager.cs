...
public class LogManager : MonoBehaviour
{
    ...
    private void CreateLog(string winner)
    {
        ...
        File.AppendAllText(logFilePath, content);
        content = "Nombre de parade du J1 brisées par le J2 : " + J1GuardBroke + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de parade du J2 brisées par le J1 : " + J2GuardBroke + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de parade du J1 trigger : " + J1ParadeTriggered + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de parade du J2 trigger : " + J2ParadeTriggered + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de combo effectué par le J1 : " + J1ComboTriggered + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de combo effectué par le J2 : " + J2ComboTriggered + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de permutations réussites par le J1 : " + J1PermutationTriggered + "\n";
        File.AppendAllText(logFilePath, content);
        content = "Nombre de permutations réussites par le J2 : " + J2PermutationTriggered + "\n";
        File.AppendAllText(logFilePath, content);
    }
