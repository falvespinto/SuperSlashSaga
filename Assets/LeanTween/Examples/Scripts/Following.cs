...
public class Following : MonoBehaviour {
    ...
    {
        LeanTween.moveLocalY(followArrow.gameObject, UnityEngine.Random.Range(-100f, 100f), 0f);

        var randomCol = new Color(UnityEngine.Random.value, UnityEngine.Random.value, UnityEngine.Random.value);
        LeanTween.color(followArrow.gameObject, randomCol, 0f);

        var randomVal = UnityEngine.Random.Range(5f, 10f);
